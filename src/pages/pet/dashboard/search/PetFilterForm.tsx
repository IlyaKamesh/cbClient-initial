...
interface IProps {
  onChange: (values: null | IPetQueryParams) => void;
  filters: IPetQueryParams;
}

const PetFilterForm = (props: IProps) => {
  ...
  return (
    <Form form={form} onValuesChange={debounceInput} initialValues={filters} layout="inline">
      <Form.Item name="petSearchParam1">
        <Input placeholder="petSearchParam1" />
      </Form.Item>

      <Form.Item name="petSearchParam2">
        <Input placeholder="petSearchParam2" />
      </Form.Item>
